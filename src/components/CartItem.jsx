...
const CartItem = ({ val }) => {
  ...
  return (
    <>
      {
        <Row className="text-dark item-row bg-white rounded-5 m-1 p-md-2 p-4 mb-4">
          <Col className="column col-6 col-sm-2 flex flex-column">
            <img
              src={val.image}
              alt={val.name}
              height={100}
          ...
          <Col className="column" s={6}>
            <div className="d-flex w-100 justify-content-end align-items-center">
              ...
              <Button
                variant="danger"
                onClick={() => dispatch(deleteItem(val && val._id))}
              >
                <i
